"""
Django settings for web_analyzer project.
...
SECRET_KEY = 'django-insecure-hcw+rp0(++a_7ma4f@r=n=86nwv+^-k-8560m2b)zbf_a30$cd'
...
ROOT_URLCONF = 'web_analyzer.urls'
...
#STATIC_URL = 'static/'
STATIC_URL = 'user_administration/static/'
